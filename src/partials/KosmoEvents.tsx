...
export default function KosmoEvents() {
  return (
    <section className="relative">
      <div className="w-full flex flex-col justify-center items-center gap-20 pt-32 py-40 bg-primary">
        ...
        <span className="text-2xl text-white text-center font-secondary leading-12">
          A gente sabe que os melhores momentos não acontecem em <br /> qualquer
          lugar.
          <b className="text-3xl">
            {" "}
            Por isso, Kozmo está presente nos eventos <br /> mais vibrantes e
            nos points mais descolados do litoral.
          </b>
        </span>
      </div>
